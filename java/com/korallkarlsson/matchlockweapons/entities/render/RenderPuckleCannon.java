...
public class RenderPuckleCannon extends Render {
	...
	EntityItem itemBarrel = new EntityItem(Minecraft.getMinecraft().world, 0D, 0D, 0D, new ItemStack(ModItems.PUCKLE_BARREL));
	EntityItem itemWheel = new EntityItem(Minecraft.getMinecraft().world, 0D, 0D, 0D, new ItemStack(ModItems.PUCKLE_STAND));
	
	
	public RenderPuckleCannon(RenderManager renderManagerIn) {
	...
	public void doRender(Entity entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        GlStateManager.pushMatrix();
        {
        	...
        	GlStateManager.translate(0, 0.5D, 0.08D); //0.12
        	//GlStateManager.scale(3/4, 3/4, 3/4);
        	
        	GlStateManager.translate(0, -0.3D - entity.rotationPitch/900, 0);
          	GlStateManager.rotate(180, 0, 0, 1);
          	GlStateManager.rotate(-entity.rotationPitch + 180F, 1, 0, 0);
          	GlStateManager.translate(0, -0.1, entity.rotationPitch/400);
