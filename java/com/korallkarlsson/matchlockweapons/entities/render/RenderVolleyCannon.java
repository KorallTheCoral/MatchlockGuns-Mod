...
public class RenderVolleyCannon extends Render {
	...
	EntityItem itemBarrel = new EntityItem(Minecraft.getMinecraft().world, 0D, 0D, 0D, new ItemStack(ModItems.VOLLEY_BARREL));
	EntityItem itemWheel = new EntityItem(Minecraft.getMinecraft().world, 0D, 0D, 0D, new ItemStack(ModItems.CANNON_WHEEL));
	
	
	public RenderVolleyCannon(RenderManager renderManagerIn) {
	...
	public void doRender(Entity entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        GlStateManager.pushMatrix();
        {
        	...
        	GlStateManager.translate(0, -0.18D, 0);
